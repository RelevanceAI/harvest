...
class TestOpenCodeConfig:
    ...
    def test_opencode_json_valid(self):
        ...
        config_path = Path(__file__).parent.parent / "src/modal_executor/config/opencode.json"
    ...
    def test_agents_md_has_key_sections(self):
        ...
        agents_path = Path(__file__).parent.parent / "src/modal_executor/config/AGENTS.md"
    ...
    def test_memory_seed_json_valid(self):
        ...
        seed_path = Path(__file__).parent.parent / "src/modal_executor/config/memory-seed.json"
